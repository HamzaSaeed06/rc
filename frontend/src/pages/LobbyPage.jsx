          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="lg:w-64 flex flex-col gap-3">
              ...
              <button onClick={handleJoin} disabled={joining}
                className="w-full py-3 rounded-xl bg-[#4f46e5] hover:bg-[#4338ca] disabled:opacity-60 text-white font-bold text-sm transition-colors shadow-xl shadow-indigo-600/20 flex items-center justify-center gap-2">
