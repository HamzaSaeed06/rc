    ...
    <div className="min-h-screen bg-[#202124] text-white font-sans">
      ...
      <div className="max-w-5xl mx-auto px-6 py-8">
        ...
        <div className="flex items-start justify-between mb-7 flex-wrap gap-4">
          ...
          <div className="flex items-center gap-3">
            <form onSubmit={handleJoinCodeSubmit} className="hidden md:flex items-center gap-0 border border-[#5f6368] hover:border-[#8ab4f8] focus-within:border-[#8ab4f8] rounded-lg px-3 transition-colors">
            ...
            <button onClick={() => setShowModal(true)}
              className="flex items-center gap-2 bg-[#4f46e5] hover:bg-[#4338ca] text-white font-medium text-sm px-4 py-2.5 rounded-lg transition-colors">
        ...
        <div className="flex flex-col sm:flex-row gap-2.5 mb-6">
          <div className="relative flex-1">
            ...
            <input type="text" value={search} onChange={e => setSearch(e.target.value)}
              ...
              className="w-full bg-[#303134] border border-[#5f6368]/50 hover:border-[#5f6368] focus:border-[#8ab4f8] text-white placeholder-[#9aa0a6] rounded-lg px-4 py-2.5 pl-9 text-sm focus:outline-none transition-colors" />
          </div>
          <div className="flex gap-1 p-1 bg-[#303134] border border-[#5f6368]/40 rounded-lg">
        ...
        {loading ? (
          ...
          <div className="text-center py-24">
            <div className="w-16 h-16 bg-[#303134] rounded-xl flex items-center justify-center mx-auto mb-4">
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4"
          ...
          <div className="bg-[#303134] border border-[#5f6368]/40 rounded-xl p-6 w-full max-w-md shadow-2xl animate-scale-in"
            onClick={e => e.stopPropagation()}>
            <div className="flex items-center justify-between mb-5">
              <h2 className="text-base font-semibold text-white">New meeting</h2>
              <button onClick={() => setShowModal(false)} className="p-1.5 rounded-lg hover:bg-[#3c4043] text-[#9aa0a6] hover:text-white transition-all">
                <X className="w-4 h-4" />
              </button>
            </div>
            <form onSubmit={handleCreateRoom} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input type="number" value={newRoom.maxParticipants}
                    ...
                    className="w-full bg-[#202124] border border-[#5f6368] focus:border-[#8ab4f8] text-white rounded-lg px-4 py-2.5 text-sm focus:outline-none transition-colors"
                    min={2} max={20} />
                </div>
                <div>
                  ...
                  <select value={newRoom.durationMinutes}
                    ...
                    className="w-full bg-[#202124] border border-[#5f6368] focus:border-[#8ab4f8] text-white rounded-lg px-4 py-2.5 text-sm focus:outline-none transition-colors appearance-none">
              ...
              <div className="flex gap-2.5 pt-1">
                ...
                <button type="submit" disabled={creating}
                  className="flex-1 py-2.5 rounded-lg bg-[#4f46e5] hover:bg-[#4338ca] text-white text-sm font-medium transition-colors flex items-center justify-center gap-2 disabled:opacity-50">
      ...
      {selectedPrivateRoom && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4"
          ...
          <div className="bg-[#303134] border border-[#5f6368]/40 rounded-xl p-6 w-full max-w-sm shadow-2xl animate-scale-in"
            onClick={e => e.stopPropagation()}>
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                <h2 className="text-sm font-semibold text-white">Private meeting</h2>
            ...
            <form onSubmit={handleVerifyPassword} className="space-y-3">
              <div className="relative">
                <input type={showJoinPw ? 'text' : 'password'} value={joinPassword}
                  ...
                  className="w-full bg-[#202124] border border-[#5f6368] focus:border-[#8ab4f8] text-white placeholder-[#5f6368] rounded-lg px-4 py-2.5 pr-10 text-sm focus:outline-none transition-colors"
                  required autoFocus />
