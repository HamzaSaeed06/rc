      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-sm">
          <div className="text-center mb-7">
            <h1 className="text-xl font-semibold text-white mb-1.5">Create account</h1>
          ...
          <div className="bg-[#303134] border border-[#5f6368]/40 rounded-xl p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              <div className="relative">
                <User className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-[#9aa0a6] pointer-events-none" />
            ...
            <p className="text-center text-sm text-[#9aa0a6] mt-5">
              ...
              <Link to="/login" className="text-[#8ab4f8] hover:underline font-medium">Sign in</Link>
            </p>
          </div>
        </div>
      </div>
